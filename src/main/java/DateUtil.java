...
public class DateUtil {
    public static void main(String[] args) {
        String strHms = getStrHm(new Date());
        System.out.println(strHms);
    ...
    private static final FastDateFormat formatHm = FastDateFormat.getInstance("yyyy-MM-dd HH:mm");
  //格式(2000-01-01 00:00 )
    ...
    //Date转换String : 年月日 时分秒格式
    public static String getStrHm(Date date) {
