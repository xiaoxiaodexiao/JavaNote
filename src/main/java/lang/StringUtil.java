...
import enums.SeparatorTypeEnum;
...
public class StringUtil {
	...
	/** 默认分隔符（,） */
	private static final String SEPARATOR_DEFAULT = SeparatorTypeEnum.COMMA.getCode();
	/** 点（.） */
	private static final String SEPARATOR_POINT = SeparatorTypeEnum.POINT.getCode();
